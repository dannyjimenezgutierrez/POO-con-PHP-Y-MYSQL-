...
<ul class="navbar-nav">
    <li class="dropdown nav-icon me-6">
        <a href="#" id="maximizeToggle" class="nav-link nav-link-lg nav-link-user" title="Maximizar o Minizar Pagina">
 ...
 <div class="d-none d-md-block text-start">
      <span class="btn btn-sm btn-outline-secondary py-0 px-2" title="Hora Actual" style="font-size:0.9rem; line-height:1,5;">
                <?php include ('acciones/reloj.php');?>
      </span>
</div>
...
<div class="d-none d-md-block text-start">
      <span class="btn btn-sm btn-outline-secondary py-0 px-2" title="Fecha Actual" style="font-size:0.9rem; line-height:1,5;">
                <?php include ('acciones/fecha.php');?>        
      </span>
</div>
...
&nbsp;&nbsp;
 ...
 <div class="d-none d-md-block text-start">
      <span class="btn btn-sm btn-outline-secondary py-0 px-2" title="Perfil" style="font-size:0.9rem;  line-height:1,5;">
    ...
    <a href="#" data-bs-toggle="dropdown" aria-expanded="false"
        class="nav-link dropdown-toggle nav-link-lg nav-link-user d-flex align-items-center">
            ...
            <div class="avatar bg-warning me-3 d-inline-block position-relative" style="width: 50px; height: 50px; border-radius: 50%;">
                <img src="img/foto.jpg" alt="Avatar de Danny" class="w-100 h-100 rounded-circle" style="object-fit: cover;">
...
<div class="dropdown-menu dropdown-menu-end shadow-lg border-0 rounded-3 p-3" style="min-width: 260px;">
  <div class="text-center">
    ...
    <div class="position-relative d-inline-block mb-3">
       <img src="img/foto.jpg" alt="Avatar de Danny" class="rounded-circle border border-3 border-light shadow-sm" style="width: 70px; height: 70px; object-fit: cover;">
